...
# def writeit(data):
#     with open('eggss.csv', 'w', newline='') as csvfile:
#         email = data['email']
#         subject = data['subject']
#         message = data['message']
...
#     spamwriter = csv.writer(csvfile, delimiter=' ',
#                             quotechar='|', quoting=csv.QUOTE_MINIMAL)
#     spamwriter.writerow(['Spams'] * 5 + ['Baked Beansd'])
...
#         if submit_form(request.form['email']):
#             return submit_form(request.form['email'])
#         else:
